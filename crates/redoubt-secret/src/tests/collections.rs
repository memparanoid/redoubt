...
test_array_mem_move!(
    ...
    i8, test_array_mem_move_i8, -42,
    i16, test_array_mem_move_i16, -1234,
    i32, test_array_mem_move_i32, -123456,
    i64, test_array_mem_move_i64, -123456789,
    i128, test_array_mem_move_i128, -123456789123456789,
    isize, test_array_mem_move_isize, -5678,
    f32, test_array_mem_move_f32, 3.14159,
    f64, test_array_mem_move_f64, 2.718281828,
    bool, test_array_mem_move_bool, true,
);
...
test_vec_mem_move!(
    ...
    i8, test_vec_mem_move_i8, -99,
    i16, test_vec_mem_move_i16, -9999,
    i32, test_vec_mem_move_i32, -999999,
    i64, test_vec_mem_move_i64, -999999999,
    i128, test_vec_mem_move_i128, -999999999999999999,
    isize, test_vec_mem_move_isize, -8888,
    f32, test_vec_mem_move_f32, 1.234,
    f64, test_vec_mem_move_f64, 5.678901234,
    bool, test_vec_mem_move_bool, false,
);
