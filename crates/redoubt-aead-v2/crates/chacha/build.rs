...
const X86_64: &str = "src/asm/chacha_x86_64.S";
const AARCH64: &str = "src/asm/chacha_aarch64.S";

/// What the crate compiles under when one of them was built.
const HAS_ASM: &str = "chacha_asm";
...
fn main() {
    ...
    cc::Build::new().file(file).compile("chacha_asm");
