...
///
/// Written out here rather than in a file of its own because the generated
/// vectors beside it reach these by `super::wycheproof`, and what decides that
/// path is a script that writes more than one crate.
pub(crate) mod wycheproof {
    ...
    /// should have been rejected and one sealed by a superseded construction
    /// are two different bugs with the same symptom.
    ...
    pub(crate) enum Flag {
        ...
        ModifiedTag,
        /// Sealed by the AEGIS of the original paper, which is a different
        /// construction under the same name. Every one of these is a vector to
        /// refuse.
        OldVersion,
        /// Pseudorandomly generated, for input sizes nobody thought to write
        /// down.
        Pseudorandom,
        /// Two messages under one tag.
        TagCollision1,
        /// Two associated data under one tag.
        TagCollision2,
    }
...
pub(crate) mod wycheproof_vectors;
