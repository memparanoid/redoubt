...
/// aarch64 assembly AEGIS-128L backend.
pub struct Aegis128LArmBackend;

#[cfg(target_arch = "aarch64")]
impl AeadApi for Aegis128LArmBackend {
    fn api_encrypt(
        &mut self,
        key: &[u8],
        nonce: &[u8],
...
mod tests {
    #[cfg(target_arch = "aarch64")]
    use super::Aegis128LArmBackend;

    #[test]
    fn instrumentation() {
        let _ = super::Aegis128LArmBackend;
    }

    #[cfg(target_arch = "aarch64")]
    #[test]
    fn test_aegis128l_wycheproof() {
        redoubt_aead_aegis_wycheproof::run_aegis128l_wycheproof_tests(&mut Aegis128LArmBackend);
    }

    #[cfg(target_arch = "aarch64")]
    #[test]
    fn test_aegis128l_roundtrip() {
        redoubt_aead_aegis_wycheproof::run_aegis128l_roundtrip_tests(&mut Aegis128LArmBackend);
    }

    #[cfg(target_arch = "aarch64")]
    #[test]
    fn test_aegis128l_flipped_tag() {
        redoubt_aead_aegis_wycheproof::run_aegis128l_flipped_tag_tests(&mut Aegis128LArmBackend);
    }
    ...
    fn test_aegis128l_generate_nonce() {
        redoubt_aead_aegis_wycheproof::run_aegis128l_generate_nonce_test(&mut Aegis128LArmBackend);
    }
}
