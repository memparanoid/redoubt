...
#[cold]
#[inline(never)]
pub(crate) fn cleanup_encode_error<T: FastZeroizable + ZeroizeMetadata, const N: usize>(
    arr: &mut [T; N],
...
#[cold]
#[inline(never)]
pub(crate) fn cleanup_decode_error<T: FastZeroizable + ZeroizeMetadata, const N: usize>(
    arr: &mut [T; N],
    buf: &mut &mut [u8],
) {
    arr.fast_zeroize();
