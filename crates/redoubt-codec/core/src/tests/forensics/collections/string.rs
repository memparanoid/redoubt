...
use crate::tests::forensics::support::needles::{TEXT, backwards, text_backwards};
use crate::tests::forensics::support::{is_found, leaves_nothing, secret_bytes};

type Held = String;

fn hold(of: usize) -> Held {
