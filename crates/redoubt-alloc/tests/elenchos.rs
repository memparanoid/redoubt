...
#[test]
fn test_an_array_replaced_is_found_while_it_holds_it() -> Result<(), AnyError> {
...
#[test]
fn test_an_array_replaced_leaves_nothing() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
#[test]
fn test_an_array_given_away_is_found_while_it_is_held() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
#[test]
fn test_an_array_given_away_leaves_nothing() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
#[test]
fn test_an_array_dropped_leaves_nothing() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
#[test]
fn test_an_option_replaced_is_found_while_it_holds_it() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
/// the capture copies.
macro_rules! an_option_replaced {
    ($name:ident, $of:expr) => {
        #[test]
...
an_option_replaced!(test_an_option_replaced_of_32_leaves_nothing, 32);
an_option_replaced!(test_an_option_replaced_of_64_leaves_nothing, 64);
an_option_replaced!(test_an_option_replaced_of_128_leaves_nothing, 128);
an_option_replaced!(test_an_option_replaced_of_512_leaves_nothing, 512);
an_option_replaced!(test_an_option_replaced_of_1024_leaves_nothing, 1024);
an_option_replaced!(test_an_option_replaced_of_4096_leaves_nothing, 4096);
an_option_replaced!(test_an_option_replaced_of_8192_leaves_nothing, 8192);
an_option_replaced!(test_an_option_replaced_of_16384_leaves_nothing, 16384);
an_option_replaced!(test_an_option_replaced_of_32768_leaves_nothing, 32768);
an_option_replaced!(test_an_option_replaced_of_65536_leaves_nothing, 65536);
...
#[test]
fn test_an_option_given_away_is_found_while_it_is_held() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
macro_rules! an_option_given_away {
    ($name:ident, $of:expr) => {
        #[test]
        fn $name() -> Result<(), AnyError> {
            let mut watch = Forensics::watching(&backwards())?;
...
an_option_given_away!(test_an_option_given_away_of_32_leaves_nothing, 32);
an_option_given_away!(test_an_option_given_away_of_64_leaves_nothing, 64);
an_option_given_away!(test_an_option_given_away_of_128_leaves_nothing, 128);
an_option_given_away!(test_an_option_given_away_of_512_leaves_nothing, 512);
an_option_given_away!(test_an_option_given_away_of_1024_leaves_nothing, 1024);
an_option_given_away!(test_an_option_given_away_of_4096_leaves_nothing, 4096);
an_option_given_away!(test_an_option_given_away_of_8192_leaves_nothing, 8192);
an_option_given_away!(test_an_option_given_away_of_16384_leaves_nothing, 16384);
an_option_given_away!(test_an_option_given_away_of_32768_leaves_nothing, 32768);
an_option_given_away!(test_an_option_given_away_of_65536_leaves_nothing, 65536);
...
an_option_dropped!(test_an_option_dropped_of_32_leaves_nothing, 32);
an_option_dropped!(test_an_option_dropped_of_64_leaves_nothing, 64);
an_option_dropped!(test_an_option_dropped_of_128_leaves_nothing, 128);
an_option_dropped!(test_an_option_dropped_of_512_leaves_nothing, 512);
an_option_dropped!(test_an_option_dropped_of_1024_leaves_nothing, 1024);
an_option_dropped!(test_an_option_dropped_of_4096_leaves_nothing, 4096);
an_option_dropped!(test_an_option_dropped_of_8192_leaves_nothing, 8192);
an_option_dropped!(test_an_option_dropped_of_16384_leaves_nothing, 16384);
an_option_dropped!(test_an_option_dropped_of_32768_leaves_nothing, 32768);
an_option_dropped!(test_an_option_dropped_of_65536_leaves_nothing, 65536);
...
#[test]
fn test_a_string_extended_is_found_while_it_holds_it() -> Result<(), AnyError> {
...
a_string_extended!(test_a_string_extended_to_32_leaves_nothing, 32);
a_string_extended!(test_a_string_extended_to_64_leaves_nothing, 64);
a_string_extended!(test_a_string_extended_to_128_leaves_nothing, 128);
a_string_extended!(test_a_string_extended_to_512_leaves_nothing, 512);
a_string_extended!(test_a_string_extended_to_1024_leaves_nothing, 1024);
a_string_extended!(test_a_string_extended_to_4096_leaves_nothing, 4096);
a_string_extended!(test_a_string_extended_to_8192_leaves_nothing, 8192);
a_string_extended!(test_a_string_extended_to_16384_leaves_nothing, 16384);
a_string_extended!(test_a_string_extended_to_32768_leaves_nothing, 32768);
a_string_extended!(test_a_string_extended_to_65536_leaves_nothing, 65536);
...
#[test]
fn test_a_string_replaced_is_found_while_it_holds_it() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&spelled_backwards())?;
...
a_string_replaced!(test_a_string_replaced_of_32_leaves_nothing, 32);
a_string_replaced!(test_a_string_replaced_of_64_leaves_nothing, 64);
a_string_replaced!(test_a_string_replaced_of_128_leaves_nothing, 128);
a_string_replaced!(test_a_string_replaced_of_512_leaves_nothing, 512);
a_string_replaced!(test_a_string_replaced_of_1024_leaves_nothing, 1024);
a_string_replaced!(test_a_string_replaced_of_4096_leaves_nothing, 4096);
a_string_replaced!(test_a_string_replaced_of_8192_leaves_nothing, 8192);
a_string_replaced!(test_a_string_replaced_of_16384_leaves_nothing, 16384);
a_string_replaced!(test_a_string_replaced_of_32768_leaves_nothing, 32768);
a_string_replaced!(test_a_string_replaced_of_65536_leaves_nothing, 65536);
...
#[test]
fn test_a_string_extended_from_a_str_is_found_while_it_holds_it() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&spelled_backwards())?;
...
macro_rules! a_string_extended_from_a_str {
    ($name:ident, $of:expr) => {
        #[test]
        fn $name() -> Result<(), AnyError> {
            let mut watch = Forensics::watching(&spelled_backwards())?;
...
a_string_extended_from_a_str!(test_a_string_extended_from_a_str_of_32_leaves_nothing, 32);
a_string_extended_from_a_str!(test_a_string_extended_from_a_str_of_64_leaves_nothing, 64);
a_string_extended_from_a_str!(test_a_string_extended_from_a_str_of_128_leaves_nothing, 128);
a_string_extended_from_a_str!(test_a_string_extended_from_a_str_of_512_leaves_nothing, 512);
a_string_extended_from_a_str!(
    test_a_string_extended_from_a_str_of_1024_leaves_nothing,
    1024
);
a_string_extended_from_a_str!(
    test_a_string_extended_from_a_str_of_4096_leaves_nothing,
    4096
);
a_string_extended_from_a_str!(
    test_a_string_extended_from_a_str_of_8192_leaves_nothing,
    8192
);
a_string_extended_from_a_str!(
    test_a_string_extended_from_a_str_of_16384_leaves_nothing,
    16384
);
a_string_extended_from_a_str!(
    test_a_string_extended_from_a_str_of_32768_leaves_nothing,
    32768
);
a_string_extended_from_a_str!(
    test_a_string_extended_from_a_str_of_65536_leaves_nothing,
    65536
);
...
#[test]
fn test_a_string_given_away_is_found_while_it_is_held() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&spelled_backwards())?;
...
macro_rules! a_string_given_away {
    ($name:ident, $of:expr) => {
        #[test]
        fn $name() -> Result<(), AnyError> {
            let mut watch = Forensics::watching(&spelled_backwards())?;
...
a_string_given_away!(test_a_string_of_32_given_away_leaves_nothing, 32);
a_string_given_away!(test_a_string_of_64_given_away_leaves_nothing, 64);
a_string_given_away!(test_a_string_of_128_given_away_leaves_nothing, 128);
a_string_given_away!(test_a_string_of_512_given_away_leaves_nothing, 512);
a_string_given_away!(test_a_string_of_1024_given_away_leaves_nothing, 1024);
a_string_given_away!(test_a_string_of_4096_given_away_leaves_nothing, 4096);
a_string_given_away!(test_a_string_of_8192_given_away_leaves_nothing, 8192);
a_string_given_away!(test_a_string_of_16384_given_away_leaves_nothing, 16384);
a_string_given_away!(test_a_string_of_32768_given_away_leaves_nothing, 32768);
a_string_given_away!(test_a_string_of_65536_given_away_leaves_nothing, 65536);
...
a_string_dropped!(test_a_string_of_32_dropped_leaves_nothing, 32);
a_string_dropped!(test_a_string_of_64_dropped_leaves_nothing, 64);
a_string_dropped!(test_a_string_of_128_dropped_leaves_nothing, 128);
a_string_dropped!(test_a_string_of_512_dropped_leaves_nothing, 512);
a_string_dropped!(test_a_string_of_1024_dropped_leaves_nothing, 1024);
a_string_dropped!(test_a_string_of_4096_dropped_leaves_nothing, 4096);
a_string_dropped!(test_a_string_of_8192_dropped_leaves_nothing, 8192);
a_string_dropped!(test_a_string_of_16384_dropped_leaves_nothing, 16384);
a_string_dropped!(test_a_string_of_32768_dropped_leaves_nothing, 32768);
a_string_dropped!(test_a_string_of_65536_dropped_leaves_nothing, 65536);
...
#[test]
fn test_a_vec_replaced_is_found_while_it_holds_it() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
a_vec_replaced!(test_a_vec_replaced_of_32_leaves_nothing, 32);
a_vec_replaced!(test_a_vec_replaced_of_64_leaves_nothing, 64);
a_vec_replaced!(test_a_vec_replaced_of_128_leaves_nothing, 128);
a_vec_replaced!(test_a_vec_replaced_of_512_leaves_nothing, 512);
a_vec_replaced!(test_a_vec_replaced_of_1024_leaves_nothing, 1024);
a_vec_replaced!(test_a_vec_replaced_of_4096_leaves_nothing, 4096);
a_vec_replaced!(test_a_vec_replaced_of_8192_leaves_nothing, 8192);
a_vec_replaced!(test_a_vec_replaced_of_16384_leaves_nothing, 16384);
a_vec_replaced!(test_a_vec_replaced_of_32768_leaves_nothing, 32768);
a_vec_replaced!(test_a_vec_replaced_of_65536_leaves_nothing, 65536);
...
#[test]
fn test_a_vec_extended_is_found_while_it_holds_it() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
a_vec_extended!(test_a_vec_extended_to_32_leaves_nothing, 32);
a_vec_extended!(test_a_vec_extended_to_64_leaves_nothing, 64);
a_vec_extended!(test_a_vec_extended_to_128_leaves_nothing, 128);
a_vec_extended!(test_a_vec_extended_to_512_leaves_nothing, 512);
a_vec_extended!(test_a_vec_extended_to_1024_leaves_nothing, 1024);
a_vec_extended!(test_a_vec_extended_to_4096_leaves_nothing, 4096);
a_vec_extended!(test_a_vec_extended_to_8192_leaves_nothing, 8192);
a_vec_extended!(test_a_vec_extended_to_16384_leaves_nothing, 16384);
a_vec_extended!(test_a_vec_extended_to_32768_leaves_nothing, 32768);
a_vec_extended!(test_a_vec_extended_to_65536_leaves_nothing, 65536);
...
#[test]
fn test_a_vec_given_away_is_found_while_it_is_held() -> Result<(), AnyError> {
    let mut watch = Forensics::watching(&backwards())?;
...
a_vec_given_away!(test_a_vec_of_32_given_away_leaves_nothing, 32);
a_vec_given_away!(test_a_vec_of_64_given_away_leaves_nothing, 64);
a_vec_given_away!(test_a_vec_of_128_given_away_leaves_nothing, 128);
a_vec_given_away!(test_a_vec_of_512_given_away_leaves_nothing, 512);
a_vec_given_away!(test_a_vec_of_1024_given_away_leaves_nothing, 1024);
a_vec_given_away!(test_a_vec_of_4096_given_away_leaves_nothing, 4096);
a_vec_given_away!(test_a_vec_of_8192_given_away_leaves_nothing, 8192);
a_vec_given_away!(test_a_vec_of_16384_given_away_leaves_nothing, 16384);
a_vec_given_away!(test_a_vec_of_32768_given_away_leaves_nothing, 32768);
a_vec_given_away!(test_a_vec_of_65536_given_away_leaves_nothing, 65536);
...
a_vec_dropped!(test_a_vec_of_32_dropped_leaves_nothing, 32);
a_vec_dropped!(test_a_vec_of_64_dropped_leaves_nothing, 64);
a_vec_dropped!(test_a_vec_of_128_dropped_leaves_nothing, 128);
a_vec_dropped!(test_a_vec_of_512_dropped_leaves_nothing, 512);
a_vec_dropped!(test_a_vec_of_1024_dropped_leaves_nothing, 1024);
a_vec_dropped!(test_a_vec_of_4096_dropped_leaves_nothing, 4096);
a_vec_dropped!(test_a_vec_of_8192_dropped_leaves_nothing, 8192);
a_vec_dropped!(test_a_vec_of_16384_dropped_leaves_nothing, 16384);
a_vec_dropped!(test_a_vec_of_32768_dropped_leaves_nothing, 32768);
a_vec_dropped!(test_a_vec_of_65536_dropped_leaves_nothing, 65536);
